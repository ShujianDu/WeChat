...
public class BillingDetailServiceImplTest {
	...
	public void testGetBillingDetail() {
		...
		// 查询已出账单
		billingDetailList = billingDetailService.getBillingDetail("1111111111111111", "ALLT", "1", "10", "2016-04-01", "2016-04-15", "CNY");
		...
		// 查询未出账单
		billingDetailList = billingDetailService.getBillingDetail("1111111111111111", "UNSM", "1", "10", "2016-04-01", "2016-04-15", "CNY");
		...
		// 查询无结果，返回null
		billingDetailList = billingDetailService.getBillingDetail("1111111111111111", "", "1", "10", "2016-04-01", "2016-04-15", "CNY");
