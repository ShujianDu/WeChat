...
<div class="Menu_content">
    ...
    <a href="${bill}" class="menu"><span class="index3 pageLink">账单查询</span></a>
    <a href="${balance}" class="menu"><span class="index4 pageLink">额度查询</span></a>
    <a href="${points}" class="menu"><span class="index2 pageLink">积分查询</span></a>
    ...
    <a href="${cardApply}" class="menu"><span class="index6 pageLink">办卡进度</span></a>
    <a href="#" class="menu"><span class="index7 pageLink">开卡激活</span></a>
    <a href="${booking}" class="menu"><span class="index8 pageLink">活动办卡</span></a>
</div>
<!--wait_box -->
<div class="wait_box">
    <div class="tip_box">
