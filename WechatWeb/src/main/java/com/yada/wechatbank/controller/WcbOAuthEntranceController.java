...
import com.yada.wechatbank.rmi.interfaces.IWCBInterface;
import com.yada.wechatbank.service.WcbOAuthEntranceService;
...
public class WcbOAuthEntranceController extends BaseController {
    ...
    public String reqCheck(String code,String otherRedirectUrl, String state)
    {
