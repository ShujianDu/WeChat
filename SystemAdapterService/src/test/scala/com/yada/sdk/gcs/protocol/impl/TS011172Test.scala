...
<GCS transactionID="011172" isRequest="true" isResponse="false">
  <system>
    ...
    <prop key="transactionNumber" value="0020160509153652"/>
  </system>
  <page key="RQ011172">
...
rece from GCS...
<?xml version="1.0" encoding="UTF-8"?>
<GCS transactionID="011172" isRequest="false" isResponse="true"><system><prop key="transactionCode" value="011172"/><prop key="transactionNumber" value="0020160509153652"/><prop key="txnTraceNumber" value="0013212550"/><prop key="transactionSessionId" value="93c4399ad67d925fa40d0693adb0a222"/><prop key="requestChannelId" value="WX01"/><prop key="txnBankCode" value="003"/><prop key="txnProvinceCode" value=""/><prop key="txnBranchCode" value="00003"/><prop key="txnCounterCode" value=""/><prop key="txnTerminalCode" value=""/><prop key="txnUserCode" value="wx0000000000"/><prop key="localBankTxnRequestTime" value="15:34:37"/><prop key="localBankTxnRequestDate" value="2016-05-09"/><prop key="localBankTxnResponseTime" value="15:34:37"/><prop key="localBankTxnResponseDate" value="2016-05-09"/><prop key="bocBankTxnRequestTime" value="15:34:37"/><prop key="bocBankTxnRequestDate" value="2016-05-09"/><prop key="bocBankTxnResponseTime" value="15:34:37"/><prop key="bocBankTxnResponseDate" value="2016-05-09"/><prop key="returnCode" value="+GC00000"/><prop key="returnMessage" value="Success"/></system><page key="RP011172"><prop key="instalAmount" value="+00000000001300000"/><prop key="instalmentFee" value="+00000000000032760"/><prop key="installmentsAlsoAmountFirst" value="+00000000000220000"/><prop key="installmentsAlsoAmountEach" value="+00000000000216000"/><prop key="billFeeMeans" value="1"/><prop key="installmentsNumber" value="6"/><prop key="channelId" value="A"/></page></GCS>
GCSResp(GCS(011172,false,true,System(Map(bocBankTxnResponseTime -> 15:34:37, txnTerminalCode -> , requestChannelId -> WX01, transactionSessionId -> 93c4399ad67d925fa40d0693adb0a222, localBankTxnRequestTime -> 15:34:37, bocBankTxnResponseDate -> 2016-05-09, localBankTxnResponseTime -> 15:34:37, returnCode -> +GC00000, txnTraceNumber -> 0013212550, txnBankCode -> 003, bocBankTxnRequestTime -> 15:34:37, localBankTxnRequestDate -> 2016-05-09, transactionCode -> 011172, txnCounterCode -> , txnBranchCode -> 00003, localBankTxnResponseDate -> 2016-05-09, txnProvinceCode -> , bocBankTxnRequestDate -> 2016-05-09, returnMessage -> Success, txnUserCode -> wx0000000000, transactionNumber -> 0020160509153652)),Some(Page(RP011172,Map(installmentsNumber -> 6, billFeeMeans -> 1, instalAmount -> +00000000001300000, installmentsAlsoAmountEach -> +00000000000216000, instalmentFee -> +00000000000032760, installmentsAlsoAmountFirst -> +00000000000220000, channelId -> A),None))))
