...
/**
  * 信用卡挂失
  */
class TS010052Test extends FlatSpec with Matchers with MockitoSugar {

  "TS010052" should "handle successful" in {
    // TODO 暂时未测试
...
//      """.stripMargin
//
//    val protocol = new TS010002(sessionID, channelID, cardNo)
